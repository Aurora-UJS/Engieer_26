...
typedef enum
{
    ...
    ID_custom_controller = 0x0302,         // 自定义控制器数据
} CmdID_e;
...
typedef enum
{
    ...
    LEN_custom_controller = 20,                  // 0x0302
...
typedef struct
{
    int32_t encoder_1_value;
    int32_t encoder_2_value;
    int32_t encoder_3_value;
    int32_t encoder_4_value;
    int32_t encoder_5_value;
    int32_t encoder_6_value;
